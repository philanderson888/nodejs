...
function httpResponse(req,res){
	...
	res.write('<html><head><title>Home</title></head><body><a href="/">Home</a> | <a href="/page2">Page 2</a> | <a href="/page3">Page 3</a><h1>Home</h1></body></html>');
	res.end();
}
...
function servePage3(req,res){
	console.log('Serving page3.htm');
	var filePath=path.join(__dirname + '/assets/view/node_86_express_06_page3.html');
	console.log('filePath is ' + filePath);
	res.sendFile(filePath);
}
